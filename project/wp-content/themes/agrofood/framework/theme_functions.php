...
function agrofood_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/redux-framework.4.3.12.zip'
            ,'required'           => true
			,'version'            => '4.3.12'
            ,'external_url'       => ''
        )
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.6.3.1.zip'
            ,'required'           => true
			,'version'            => '6.3.1'
            ,'external_url'       => ''
        )
		,array(
            'name'                => 'Elementor'
            ,'slug'               => 'elementor'
			,'source'             => 'https://downloads.wordpress.org/plugin/elementor.3.6.1.zip'
            ,'required'           => true
			,'version'            => '3.6.1'
            ,'external_url'       => ''
        )
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.4.8.7.zip'
            ,'required'           => false
			,'version'            => '4.8.7'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.3.7.0.zip'
            ,'required'           => false
			,'version'            => '3.7.0'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/customer-reviews-woocommerce.4.38.zip'
            ,'required'           => false
			,'version'            => '4.38'
            ,'external_url'       => ''
        )
