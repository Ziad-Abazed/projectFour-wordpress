...
function agrofood_template_loop_product_thumbnail(){
	global $product;
	$lazy_load = agrofood_get_theme_options('ts_prod_lazy_load') && !( defined( 'DOING_AJAX' ) && DOING_AJAX );
...
if( class_exists('YITH_WCWL') ){
	...
	add_filter('yith-wcwl-browse-wishlist-label', 'agrofood_yith_wcwl_browse_wishlist_label');
	function agrofood_yith_wcwl_browse_wishlist_label(){
